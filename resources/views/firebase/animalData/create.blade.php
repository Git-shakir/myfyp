            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4>Add Animal Data
                            <a href="{{ url('animalsData') }}" class="btn btn-sm btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">

                        <form action="{{ route('add-animalData-post') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="age" id="age" class="form-control"
                                    value="{{ old('age') }}" placeholder="Automatically calculated" readonly>
                            </div>
                            ...
                            <script>
                                $(document).ready(function() {
                                    ...
                                    $('#bdate').on('change', function() {
                                        ...
                                        if (ageInMonths !== null) {
                                            $('#age').val(ageInMonths); // Populate the Age (Months) field
                                        } else {
